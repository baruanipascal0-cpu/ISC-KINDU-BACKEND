        ...
        <div class="card-header">
            <div>
                ...
                <div class="admin-tabs">
                    ...
                    @foreach (['Communique', 'Document', 'Article', 'Ressource', 'Bibliotheque', 'These', 'Centre de recherche', 'In memoriam', 'Alumni'] as $item)
                            ...
                            <td>
                                <div class="actions">
                                    ...
                                    @if ($publication->is_published)
                                        <a class="btn btn-secondary" href="/publications/{{ $publication->slug }}" target="_blank">Site</a>
                                    @endif
